...
/**
 * @typedef {Object} FirebaseDataManagerConfig
...
class FirebaseDataManager extends EventEmitter
{
	/**
	 * @param {Firebase} firebase
	 * @param {FirebaseDataManagerConfig} config
	 */
	constructor(firebase, config)
	{
		...
		/**
		 * @type {FirebaseDataManagerConfig}
		 */
		this.config = config;
