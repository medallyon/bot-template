...
class Browser extends Array
{
    ...
    constructor(existingMessageOrChannel, items, defaultPageEmbed = {})
    {
        ...
        else if (existingMessageOrChannel instanceof Discord.TextChannel)
    ...
    _resolveMessage()
    {
        return new Promise((resolve, reject) =>
        {
            ...
            this.channel.send(this.currentPage.setFooter(`Viewing page ${this.pointer + 1}/${this.length} | Use the emojis for navigation.`))
                .then(msg =>
                {
                    this.message = msg;
